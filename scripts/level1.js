...
var _questions    =    ["Висит груша, нельзя скушать.","Каво?", "Как зовут Какейна?"];

var _rightAnswer  =    ["Лампочка","Деда", "Ариаки"];
var _wrongAnswers =    [["человек1","человек2","человек3","человек4","человек5","человек6"]
                         ,["человек1","человек2","человек3","человек4","человек5","человек6"]
                         ,["Семен","Сергеичь","Саныч","Толя","Влад","ДЫЫО"]];
